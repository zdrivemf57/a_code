...
export default function ItemSaveForm({ item = defaultItem }) {
  ...
  // フォーム値の取得とバリデーション
  const {refs: {nameRef, amountRef, locationRef, noteRef}, validate} = useItemForm();
    ...
    <form onSubmit={handleSubmit}>
      ...
      {item?.id && (
        <div className="form-group mb-3">
          <label htmlFor="formId">備品ID</label>
          <input
      ...
      <div className="form-group">
        <input type="submit" className="btn btn-primary" value="保存" disabled={isPending} />
